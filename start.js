...
const onTargetEvent = async (target, type) => {
  ...
  try {
    ...
    const page = await target.page()
    if (page == null) { console.log('not a page'); return }
    // await wait(2000)
